...
int main(int argc, char** argv)
{
    ...
    // TODO: define communicator, ranks, size
    ...
    const int n = // TODO: number of particles per rank
    const double extents = // TODO: lenght of chunk (space not particles) assigned to each rank 

    const double startX = // TODO: starting x-position per rank
    const double endX = // TODO: ending x-position per rank
